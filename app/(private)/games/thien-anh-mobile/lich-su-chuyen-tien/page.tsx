...
export default function LichSuChuyenTienPage() {
  ...
  const getTypeBadge = (type: number) => {
    switch (type) {
      case 1:
        return <Badge variant='default'>Nạp vào</Badge>
      case 2:
        return <Badge variant='secondary'>Chuyển ra</Badge>
      default:
  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground'>Thiên Ảnh Mobile</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Danh sách giao dịch</CardTitle>
          <CardDescription>Lịch sử chuyển tiền của người dùng</CardDescription>
        </CardHeader>
        <CardContent>
